...
def TestPattern(data, ihs_patterns, ihs_df):
    ...
    return ihs_df, finalCapitalIHS, win_rateIHS, avgLossIHS, avgWinIHS, max(positiveIHSreturns), min(negativeIHSreturns)
...
if __name__ == '__main__':
    ...
    ihs_patterns = find_hs_patterns(dat_slice, 3, early_find=False)
    ...
    ihs_df, finalCapitalIHS, win_rateIHS, avgLossIHS, avgWinIHS, maxWinIHS, maxLossIHS = TestPattern(data, ihs_patterns, ihs_df)
